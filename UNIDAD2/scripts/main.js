...
function validarEntrada(input) {
    ...
    var numeroValido = /^-?\d+$/;
    if (!valor.match(numeroValido)) {
        alert("Ingresa solo números y signos.");
        input.value = "";
    }
}

// Event listener para validar la entrada del usuario
document.getElementById("numeroBusqueda").addEventListener("input", function () {
    validarEntrada(this);
});
